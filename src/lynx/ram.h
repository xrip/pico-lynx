...
class CRam : public CLynxBase
{
   ...
   public:
      ...
      CRam(UBYTE *filedata, ULONG2 filesize)
      {
      ...
      void   Poke(ULONG2 addr, UBYTE data) { mRamData[addr] = data;};
      UBYTE  Peek(ULONG2 addr) {return mRamData[addr];};
      ULONG2  ObjectSize(void) {return RAM_SIZE;};
   ...
   private:
      ...
      UBYTE	*mHomebrewData;
      ULONG2	mHomebrewSize;
      ULONG2 mHomebrewAddr;
};
