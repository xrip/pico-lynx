...
class CCart : public CLynxBase
{
   ...
   public:
      CCart(UBYTE *gamedata, ULONG2 gamesize);
      ~CCart();
   ...
   public:
      ...
      ULONG2	ReadCycle(void) {return 15;};
      ULONG2	WriteCycle(void) {return 15;};
      void	BankSelect(EMMODE newbank) {mBank=newbank;}
      ULONG2	ObjectSize(void) {return (mBank == bank0) ? mMaskBank0 + 1 : mMaskBank1 + 1;};
      ...
      ULONG2	CartGetRotate(void) {return (mFileHeader.rotation > 2) ? CART_NO_ROTATE : mFileHeader.rotation;};
      bool	CartGetAudin(void) { return mFileHeader.aud_bits&0x01;};
      UBYTE	CartGetEEPROMType(void) { return mFileHeader.eeprom;};
      ULONG2	CRC32(void) { return mCRC32; };
      ...
      inline ULONG2 GetCounterValue(void) {return mCounter;}; // for eeprom

      // Data members

   public:
      ULONG2	mWriteEnableBank1;
