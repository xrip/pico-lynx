...
class CSystemBase
{
   ...
   public:
      ...
      virtual void	Poke_CPU(ULONG2 addr, UBYTE data)=0;
      virtual UBYTE	Peek_CPU(ULONG2 addr)=0;
      virtual void	PokeW_CPU(ULONG2 addr, UWORD data)=0;
      virtual UWORD	PeekW_CPU(ULONG2 addr)=0;
