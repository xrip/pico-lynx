...
class CSusie : public CLynxBase
{
   public:
      ...
      ULONG2	ReadCycle(void) {return 9;};
      ULONG2	WriteCycle(void) {return 5;};
      ULONG2	ObjectSize(void) {return SUSIE_SIZE;};

      void	SetButtonData(ULONG2 data) { mJOYSTICK.Byte=(UBYTE)data;mSWITCHES.Byte=(UBYTE)(data >> 8);};
      ULONG2	GetButtonData(void) {return mJOYSTICK.Byte + (mSWITCHES.Byte << 8);};

      ULONG2	PaintSprites(void);

   private:
      inline ULONG2 LineInit(ULONG2 voff) {
   ...
   inline void WritePixel(ULONG2 hoff, ULONG2 pixel) {
      ULONG2 scr_addr= mLineBaseAddress + (hoff >> 1);
   ...
   inline ULONG2 ReadPixel(ULONG2 hoff) {
   ...
   inline void WriteCollision(ULONG2 hoff, ULONG2 pixel) {
      ULONG2 col_addr= mLineCollisionAddress + (hoff >> 1);
   ...
   inline ULONG2 ReadCollision(ULONG2 hoff) {
   ...
   private:
      ...
      ULONG2		mLineType;
      ULONG2		mLineShiftRegCount;
      ULONG2		mLineShiftReg;
      ULONG2		mLineRepeatCount;
      ULONG2		mLinePixel;
      ULONG2		mLinePacketBitsLeft;

      SLONG		mCollision;

      UBYTE		*mRamPointer;

      ULONG2		mLineBaseAddress;
      ULONG2		mLineCollisionAddress;
